...
class TestPipelineConfig(unittest.TestCase):
    ...
    def test_from_dict_roundtrip(self) -> None:
        ...
        self.assertEqual(restored.milo_preset, "high")
...
class TestPipelineSessionReset(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.session.current_stage = PipelineStage.MILO_RECONSTRUCT
...
class TestPipelineSessionStageLifecycle(unittest.TestCase):
    ...
    def test_progress_checkpoint_update(self) -> None:
        self.session.stage_progress(
            PipelineStage.MILO_RECONSTRUCT, progress=50.0, checkpoint_id="ckpt-42"
        )
...
class TestPipelineSessionConfirmation(unittest.TestCase):
    ...
    def test_require_next_stage_confirmation(self) -> None:
        self.session.require_next_stage_confirmation(
            PipelineStage.MILO_RECONSTRUCT, PipelineStage.TEXTURE_BAKE, "proceed?"
        )
...
class TestPipelineSessionClearConfirmation(unittest.TestCase):
    ...
    def test_clear_resets_confirmation_fields(self) -> None:
        ...
        session.require_next_stage_confirmation(
            PipelineStage.MILO_RECONSTRUCT, PipelineStage.TEXTURE_BAKE, "msg"
        )
