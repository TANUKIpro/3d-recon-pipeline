...
GWRAPPING_PRESET_CUSTOM = "custom"
GWRAPPING_ITERATIONS = 30000
GWRAPPING_RASTERIZER = "ours"
GWRAPPING_RASTERIZERS: set[str] = {"ours", "radegs"}
GWRAPPING_RESOLUTION = 2
GWRAPPING_USE_MASKS = True
GWRAPPING_USE_DEPTH = True
GWRAPPING_EXTRACTION_METHOD = "pivot"
GWRAPPING_EXTRACTION_METHODS: set[str] = {"pivot", "primal"}
GWRAPPING_PRESETS: dict[str, dict[str, object]] = {
    "default": {
...
GWRAPPING_PRESET_CHOICES: set[str] = set(GWRAPPING_PRESETS) | {
