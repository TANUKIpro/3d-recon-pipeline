...
_CHECKPOINTS: dict[int, Any] = {
    ...
    4: (
        _checkpoint(
            ...
            cleanup_dirs=("gwrapping_workspace", "colmap_sparse_filtered"),
        ...
        _checkpoint(
            "s4.trim",
            label="Collect output mesh",
            patterns=_patterns(r"collecting output|selected gaussianwrapping mesh"),
            cleanup_dirs=("gwrapping_workspace", "colmap_sparse_filtered"),
            cleanup_files=("object_mesh.ply",),
        ),
        _checkpoint(
...
_STAGE_FALLBACK_RESET: dict[int, dict[str, tuple[str, ...]]] = {
    ...
    4: {
        "dirs": ("gwrapping_workspace", "colmap_sparse_filtered"),
