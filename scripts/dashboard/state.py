...
STAGE_LABELS: dict[int, str] = {
    ...
    PipelineStage.GWRAPPING_RECONSTRUCT: "GaussianWrapping Reconstruction",
...
class PipelineConfig:
    ...
    gwrapping_preset: str = GWRAPPING_PRESET
    gwrapping_preset_base: str = GWRAPPING_PRESET
    gwrapping_iterations: int = GWRAPPING_ITERATIONS
    gwrapping_rasterizer: str = GWRAPPING_RASTERIZER
    gwrapping_resolution: int = GWRAPPING_RESOLUTION
    gwrapping_use_masks: bool = GWRAPPING_USE_MASKS
    gwrapping_use_depth: bool = GWRAPPING_USE_DEPTH
    gwrapping_extraction_method: str = GWRAPPING_EXTRACTION_METHOD
    ...
    def to_gwrapping_settings(self):
        from scripts.gwrapping_config import GWrappingSettings

        return GWrappingSettings.from_config_mapping(
            self.to_dict(),
            preset=self.gwrapping_preset,
        )
